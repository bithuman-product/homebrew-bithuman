...
class BithumanCli < Formula
  ...
  # Current published release: v2.3.20 (embedded livekit free ports — stale-orphan dispatch fix). Apple Silicon (arm64).
  # (Engine core stays libessence 1.19.1 / ABI v7 — a separate axis.)
  url "https://github.com/bithuman-product/homebrew-bithuman/releases/download/v2.3.20/bithuman-aarch64-apple-darwin.tar.gz"
  version "2.3.20"
  sha256 "8d470fe370b71d5b20a8160aacfe554eac2358e897016764e93c66392612025c"
  license "Apache-2.0"
