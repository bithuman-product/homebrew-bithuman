...
// while the essence2 adapter overrides them with its be_essence2_* forms
...
public protocol BithumanEngine: AnyObject {
    ...
    // extra code; the essence2 adapter OVERRIDES them with its be_essence2_*
...
public extension BithumanEngine {
    ...
    // four with its be_essence2_* zero-alloc forms. They are protocol REQUIREMENTS
